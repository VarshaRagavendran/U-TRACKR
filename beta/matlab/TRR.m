...
SR1 = readtable('NewImageCoords1234.xlsx');
...
scale2 = 1;
%SR1
cam1_pixel_X = mean(table2array(SR1(:,2)))*scale1;
cam1_pixel_Y = mean(table2array(SR1(:,3)))*scale2;

cam2_pixel_X = mean(table2array(SR1(:,4)))*scale1;
cam2_pixel_Y = mean(table2array(SR1(:,5)))*scale2;

cam3_pixel_X = mean(table2array(SR1(:,6)))*scale1;
cam3_pixel_Y = mean(table2array(SR1(:,7)))*scale2;

cam4_pixel_X = mean(table2array(SR1(:,8)))*scale1;
cam4_pixel_Y = mean(table2array(SR1(:,9)))*scale2;

%SR2
cam1_pixel_X2 = mean(table2array(SR2(:,2)))*scale1;
cam1_pixel_Y2 = mean(table2array(SR2(:,3)))*scale2;

cam2_pixel_X2 = mean(table2array(SR2(:,4)))*scale1;
cam2_pixel_Y2 = mean(table2array(SR2(:,5)))*scale2;

cam3_pixel_X2 = mean(table2array(SR2(:,6)))*scale1;
cam3_pixel_Y2 = mean(table2array(SR2(:,7)))*scale2;

cam4_pixel_X2 = mean(table2array(SR2(:,8)))*scale1;
cam4_pixel_Y2 = mean(table2array(SR2(:,9)))*scale2;

%SR3
cam1_pixel_X3 = mean(table2array(SR3(:,2)))*scale1;
cam1_pixel_Y3 = mean(table2array(SR3(:,3)))*scale2;

cam2_pixel_X3 = mean(table2array(SR3(:,4)))*scale1;
cam2_pixel_Y3 = mean(table2array(SR3(:,5)))*scale2;

cam3_pixel_X3 = mean(table2array(SR3(:,6)))*scale1;
cam3_pixel_Y3 = mean(table2array(SR3(:,7)))*scale2;

cam4_pixel_X3 = mean(table2array(SR3(:,8)))*scale1;
cam4_pixel_Y3 = mean(table2array(SR3(:,9)))*scale2;

%SR4
cam1_pixel_X4 = mean(table2array(SR4(:,2)))*scale1;
cam1_pixel_Y4 = mean(table2array(SR4(:,3)))*scale2;

cam2_pixel_X4 = mean(table2array(SR4(:,4)))*scale1;
cam2_pixel_Y4 = mean(table2array(SR4(:,5)))*scale2;

cam3_pixel_X4 = mean(table2array(SR4(:,6)))*scale1;
cam3_pixel_Y4 = mean(table2array(SR4(:,7)))*scale2;

cam4_pixel_X4 = mean(table2array(SR4(:,8)))*scale1;
cam4_pixel_Y4 = mean(table2array(SR4(:,9)))*scale2;
